...
# FNN 960*480*120*（20+4）
class FaceRecgNet1(nn.Module):
    def __init__(self, name_num, pose_num):
        super(FaceRecgNet1, self).__init__()
        self.fc0 = nn.Linear(960, 480)
        self.fc1 = nn.Linear(480, 120)
        self.fc2 = nn.Linear(120, name_num)
        self.fc3 = nn.Linear(120, pose_num)
...
# FNN 960*480*（20+4）
class FaceRecgNet2(nn.Module):
    def __init__(self, name_num, pose_num):
        super(FaceRecgNet2, self).__init__()
        self.fc1 = nn.Linear(960, 480)
        self.fc2 = nn.Linear(480, name_num)
        self.fc3 = nn.Linear(480, pose_num)
...
# FNN 960*120*（20+4）
class FaceRecgNet3(nn.Module):
    def __init__(self, name_num, pose_num):
        super(FaceRecgNet3, self).__init__()
...
# FNN 960*（20+4）
class FaceRecgNet4(nn.Module):
    def __init__(self, name_num, pose_num):
        super(FaceRecgNet4, self).__init__()
        self.fc2 = nn.Linear(960, name_num)
        self.fc3 = nn.Linear(960, pose_num)
...
if __name__ == '__main__':
    ...
    plt.subplot(3, 1, 1)
    plt.plot(epochs, n_acc_list, 'r-', label='CNN')
    plt.legend()
    plt.subplot(3, 1, 2)
    plt.plot(epochs, p_acc_list, 'r-', label='CNN')
    plt.legend()
    plt.subplot(3, 1, 3)
    plt.plot(epochs, loss_list, 'r-', label='CNN')
    plt.legend()
    ...
    epochs = range(1, epoch_num + 1)
    plt.subplot(3, 1, 1)
    plt.plot(epochs, n_acc_list, linestyle=line_styles[0], color=gray_colors[0], label='4Layers-480+120')
    plt.legend()
    plt.subplot(3, 1, 2)
    plt.plot(epochs, p_acc_list, linestyle=line_styles[0], color=gray_colors[0], label='4Layers-480+120')
    plt.legend()
    plt.subplot(3, 1, 3)
    plt.plot(epochs, loss_list, linestyle=line_styles[0], color=gray_colors[0], label='4Layers-480+120')
    plt.legend()

    # 模型2
    model = FaceRecgNet2(name_num, pose_num)
    model.to(device)
    criterion = nn.CrossEntropyLoss()
    optimizer = optim.SGD(model.parameters(), lr=learning_rate, momentum=0.5)
    loss_list = []
    ...
    epochs = range(1, epoch_num + 1)
    plt.subplot(3, 1, 1)
    plt.plot(epochs, n_acc_list, linestyle=line_styles[1], color=gray_colors[1], label='3Layers-480')
    plt.legend()
    plt.subplot(3, 1, 2)
    plt.plot(epochs, p_acc_list, linestyle=line_styles[1], color=gray_colors[1], label='3Layers-480')
    plt.legend()
    plt.subplot(3, 1, 3)
    plt.plot(epochs, loss_list, linestyle=line_styles[1], color=gray_colors[1], label='3Layers-480')
    plt.legend()


    # 模型3
    model = FaceRecgNet3(name_num, pose_num)
    model.to(device)
    criterion = nn.CrossEntropyLoss()
    optimizer = optim.SGD(model.parameters(), lr=learning_rate, momentum=0.5)
    loss_list = []
    ...
    epochs = range(1, epoch_num + 1)
    plt.subplot(3, 1, 1)
    plt.plot(epochs, n_acc_list, linestyle=line_styles[2], color=gray_colors[2], label='3Layers-120')
    plt.legend()
    plt.subplot(3, 1, 2)
    plt.plot(epochs, p_acc_list, linestyle=line_styles[2], color=gray_colors[2], label='3Layers-120')
    plt.legend()
    plt.subplot(3, 1, 3)
    plt.plot(epochs, loss_list, linestyle=line_styles[2], color=gray_colors[2], label='3Layers-120')
    plt.legend()

    # 模型3
    model = FaceRecgNet4(name_num, pose_num)
    model.to(device)
    criterion = nn.CrossEntropyLoss()
    optimizer = optim.SGD(model.parameters(), lr=learning_rate, momentum=0.5)
    loss_list = []
    ...
    epochs = range(1, epoch_num + 1)
    plt.subplot(3, 1, 1)
    plt.plot(epochs, n_acc_list, linestyle=line_styles[3], color=gray_colors[3], label='2Layers-0')
    plt.legend()
    plt.subplot(3, 1, 2)
    plt.plot(epochs, p_acc_list, linestyle=line_styles[3], color=gray_colors[3], label='2Layers-0')
    plt.legend()
    plt.subplot(3, 1, 3)
    plt.plot(epochs, loss_list, linestyle=line_styles[3], color=gray_colors[3], label='2Layers-0')
    plt.legend()
